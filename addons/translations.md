...
- [Q2A 1.7.x - Galician (Galego)]() by [Oficina de Software Libre](http://www.cixug.es/).
...
- [Q2A 1.7.x - Norwegian (Norsk)]() @ [Nettport](http://nettport.com/).
...
- [Q2A 1.6.x - German (Deutsch)]()[Finanzenfragen.de](http://www.finanzenfragen.de/). Also: [German (Deutsch) formal](http://www.trvb128.at/qa-lang/qa-lang-de-formal-163.zip) by Peter Chiochetti.
...
- [Q2A 1.6.x - Indonesian (Bahasa Indonesia)]() [KTTRACK](http://www.kttrack.com/).
